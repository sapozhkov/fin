...
class TestAlgorithm:
    ...
    def get_max_steps_by_step_size(
        ...
        for candle in candles.candles:
            ...
            max_steps = max(
                max_steps,
                TestAlgorithm.calc_required_step_max_cnt(
                    math.ceil(abs(c_open - c_high)), step_size, config.step_size_shift),
                TestAlgorithm.calc_required_step_max_cnt(
                    math.ceil(abs(c_open - c_low)), step_size, config.step_size_shift),
            )
