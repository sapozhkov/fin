...
```
20 3 * * * python3 ~/fin/expire_unfinished.py >> ~/log/expired.log 2>&1
30 3 * * * python3 ~/fin/starter.py >> ~/log/starter.log 2>&1
5 21 * * * python3 ~/fin/task_set_upd_instr.py >> ~/log/task_set.log 2>&1
*/1 * * * * python3 ~/fin/task_worker.py >> ~/log/tasks.log 2>&1
0 2 1 * * python3 ~/fin/log_archiver.py
```
